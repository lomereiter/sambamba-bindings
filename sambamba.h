...
bam_reader_t 
bam_readrange_front_copy_into_and_pop_front(bam_read_range_t, char* buffer);
...
bool bam_read_proper_pair(bam_read_t);
bool bam_read_is_unmapped(bam_read_t);
bool bam_read_mate_is_unmapped(bam_read_t);
bool bam_read_is_reverse_strand(bam_read_t);
bool bam_read_mate_is_reverse_strand(bam_read_t);
bool bam_read_is_first_of_pair(bam_read_t);
bool bam_read_is_second_of_pair(bam_read_t);
...
uint8_t bam_read_tag_type_id(bam_read_t, const char* tag_name);

char bam_read_char_tag(bam_read_t, const char*);
int8_t bam_read_int8_tag(bam_read_t, const char*);
uint8_t bam_read_uint8_tag(bam_read_t, const char*);
int16_t bam_read_int16_tag(bam_read_t, const char*);
uint16_t bam_read_uint16_tag(bam_read_t, const char*);
int32_t bam_read_int32_tag(bam_read_t, const char*);
uint32_t bam_read_uint32_tag(bam_read_t, const char*);
float bam_read_float_tag(bam_read_t, const char*);
aint8_s bam_read_int8_array_tag(bam_read_t, const char*);
auint8_s bam_read_uint8_array_tag(bam_read_t, const char*);
aint16_s bam_read_int16_array_tag(bam_read_t, const char*);
auint16_s bam_read_uint16_array_tag(bam_read_t, const char*);
aint32_s bam_read_int32_array_tag(bam_read_t, const char*);
